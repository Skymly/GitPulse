...
|--------|------|----------------|------|
| **M7** | 仓库详情页（README Markdown、元数据、分支、Release）+ Windows Mica/Acrylic | RestAPI + platform | 🔄 实现基本完成，待提交、验收与 ROADMAP 归档 |
| **M8** | PR Diff 查看器（Files Changed、行内 review comment） | RestAPI | 🔄 实现基本完成，待提交、`CHANGELOG.md` 条目补全与 ROADMAP 归档 |
