...
|--------|------|----------------|------|
| **M7** | 仓库详情页（README Markdown、元数据、分支、Release）+ Windows Mica/Acrylic | RestAPI + platform | 🔄 实现基本完成，待提交与验收 |
| **M8** | PR Diff 查看器（Files Changed、行内 review comment） | RestAPI | 🔄 实现基本完成，待提交与验收 |

实现计划见 [plans/MilestoneM7M8.md](plans/MilestoneM7M8.md)。
...
|--------|------|----------------|
| **M9** | Search（仓库 / Issue / PR / 代码，GitHub Search API） | RestAPI |
