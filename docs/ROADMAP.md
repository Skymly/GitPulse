...
功能与技术 backlog 的滚动清单。里程碑编号 **M0–M44**；完成项移入「已完成（归档）」章节。
...
| 项 | 说明 | Observables 域 |
|----|------|----------------|
| **M44** | v0.32.0 Ready for review：PR Conversation 对 open draft 调用 `POST /pulls/{number}/ready_for_review`（[plan](plans/0.32.md)，[#407](https://github.com/Skymly/GitPulse/issues/407)） | RestAPI |
...
| **M31** ✅ | v0.19.0 Annotation file：Check Run annotation 以 head SHA 只读打开 Contents ?ref=（[#287](https://github.com/Skymly/GitPulse/issues/287)） | RestAPI |
