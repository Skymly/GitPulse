...
| **阶段** | **v0.32.0 已发布**；M44 已完成（Conversation Ready for review；Win zip + 签名 APK；见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
...
里程碑 **M0–M44** 见 [docs/ROADMAP.md](docs/ROADMAP.md)。**不要在本文件重复完整表格**——以 ROADMAP 为唯一 backlog 源。
