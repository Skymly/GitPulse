...
| **阶段** | **v0.3.0 已发布**；M15 已完成（Submit Pull Request Review：PR detail 列出已提交 Review 并立即提交 COMMENT / APPROVE / REQUEST_CHANGES；Win zip + 签名 APK；见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
