...
| **阶段** | **v0.5.0 已发布**；M17 已完成（Repos 页 My repos / Starred 切换；Win zip + 签名 APK；见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
...
里程碑 **M0–M17** 见 [docs/ROADMAP.md](docs/ROADMAP.md)。**不要在本文件重复完整表格**——以 ROADMAP 为唯一 backlog 源。
