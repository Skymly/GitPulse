...
| **阶段** | **v0.7.0 已发布**；M22 进行中（Check Run detail；见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
...
里程碑 **M0–M22** 见 [docs/ROADMAP.md](docs/ROADMAP.md)。**不要在本文件重复完整表格**——以 ROADMAP 为唯一 backlog 源。
