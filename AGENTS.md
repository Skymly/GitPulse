...
| **阶段** | **v0.7.0 已发布**；产品 **0.31.0**（M43）已完成，下一刀待定（见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
...
里程碑 **M0–M43** 见 [docs/ROADMAP.md](docs/ROADMAP.md)。**不要在本文件重复完整表格**——以 ROADMAP 为唯一 backlog 源。
