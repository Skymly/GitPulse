...
| **阶段** | **v0.32.0 已发布**；产品 **0.33.0**（M45）已完成，下一刀待定（见 [docs/ROADMAP.md](docs/ROADMAP.md)） |
...
里程碑 **M0–M45** 见 [docs/ROADMAP.md](docs/ROADMAP.md)。**不要在本文件重复完整表格**——以 ROADMAP 为唯一 backlog 源。
